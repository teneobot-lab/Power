                ...
                <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8">
                    <div className="flex items-center justify-between mb-8">
                        <div>
                            ...
                            <p className="text-slate-500 text-sm mt-1">Pastikan URL GAS sudah benar untuk membackup seluruh data ke Spreadsheet.</p>
                        </div>
                    ...
                    <div className="bg-slate-50 rounded-2xl p-6 border border-slate-200 space-y-6">
                        <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-xs text-slate-500 mt-1">Gunakan fitur ini untuk mengirim ulang seluruh data Inventory, Transaksi, dan Supplier ke Spreadsheet.</p>
